 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://users/", wsdlLocation = "http://localhost:1712/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://users/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1712/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://users/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://users/", "UserServicePort"), UserService.class, features);
    }
